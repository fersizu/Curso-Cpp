...
int main(){
std::cout<<"the range for short is form"<<std::numeric_limits<short>::min()<< " to "    
<< std::numeric_limits<short>::max()<<std::endl;

std::cout <<"the range for unsigned short is form "<< std::numeric_limits<unsigned short>::min() << " to "    
<<std::numeric_limits<unsigned short>::max()<<std::endl;


std::cout<<"The range por int is from "<<std::numeric_limits<int>::min()<<" to "

//tengo una nota en obsidian Personal/Curso C++/11 09 2023
#include <iostream>
...
int main(){
  ...
  /*
   Devuelve el mismo resultado que lo de arriba
  std::cout<<"Valor 1 : "<< value1 <<::std::endl;
  std::cout<<"Valor 2 : "<< value2 <<::std::endl;
  */

//solamente acepta positivos.
unsigned int value3 {4};
// unsigned int value4 {-5}; no puede haber negativos sin signo, error de compilacion.


  
  std::cout<< "tamaño valor 1: "<< sizeof(value1)<<::std::endl;
  std::cout<< "tamaño valor 2: "<< sizeof(value2)<<::std::endl;
